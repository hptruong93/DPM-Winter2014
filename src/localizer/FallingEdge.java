...
/**
 * 
 * This class works using the Falling Edge detections: only detect falling edges.
 * @see USLocalizerDoubleEdge for detail explanations.
 * 
 */
public class FallingEdge extends Localizer {

	private double left, back;
	
	public FallingEdge(Odometer odometer, WheelDriver navigator, ContinuousUSPoller poller) {
